...
//            }) { Text("Limpiar") }
        ...
        Button(onClick = {
            if(password == confirmPassword) {
                ...
                registerViewModel.sendErrorMessage("Las contraseñas no coinciden.")
            }
        },
            enabled = email.isNotBlank() && password.isNotBlank() && fullName.isNotBlank() && confirmPassword.isNotBlank()
        ) {
            Text("Registrarse")
        }
        }
